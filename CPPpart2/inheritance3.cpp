// Here Base class function is getting called bcz we are having base class pointer so compiler will take decision 
// take according to the pointer not by object 
// Now If I want to calculate the salary of the derived class i. e i have to make the Salary of base function 
// as virtual in the next prog. Inheritance4.cpp
